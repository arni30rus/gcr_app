          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // ВАРИАНТ 1: Ваше облако (требует авторизации)
                ElevatedButton.icon(
                ...
                ElevatedButton.icon(
                  ...
                  onPressed: () async {
                    ...
                    // Передаем пустые строки, Supabase не инициализируется
                ...
                OutlinedButton.icon(
                  ...
                  label: const Text('Использовать свою базу Supabase', style: TextStyle(fontSize: 16)),
                ),
              ...
              TextButton.icon(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => const SetupOwnDbGuideScreen()),
                  );
                },
                label: const Text(
                  'Инструкция: Как создать свою базу Supabase',
                  ...
                  ElevatedButton(
                    onPressed: () async {
                      ...
                      widget.onConfigComplete(_customUrlController.text, _customKeyController.text);
                    },
                    child: const Text('Подключиться к своей базе'),
                  )
                ]
              ],
            ),
